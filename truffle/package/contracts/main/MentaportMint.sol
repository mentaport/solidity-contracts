...
contract MentaportMint is MentaportERC721 {
    ...
    address internal initMentaportAccount =
        0x163f3475D1C4F194BD381B230a543DAA8D3f7c0d;
    ...
    function mintLocation(
        ...
        onlyValidSigner(
            _mintRequest.receiver,
            _mintRequest.timestamp,
            _mintRequest.locationRuleId,
            _mintRequest.signature
        )
        returns (uint256)
    {
        require(
        ...
        require(
            _checkMintSignature(_mintRequest.signature),
